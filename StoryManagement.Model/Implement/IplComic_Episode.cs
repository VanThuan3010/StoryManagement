...
{
    public class IplComic_Episode : Repository<Comic_Episode>, IComic_Episode
    {
        public IConfiguration _configuration { get; }
        internal string _cnnString;
        public StoryContext _context;
        public IplComic_Episode(StoryContext context, IConfiguration configuration) : base(context)
        {
            _context = context;

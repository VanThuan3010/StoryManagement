...
{
    public class IplComic_Images : Repository<Comic_Images>, IComic_Images
    {
        public IConfiguration _configuration { get; }
        internal string _cnnString;
        public StoryContext _context;
        public IplComic_Images(StoryContext context, IConfiguration configuration) : base(context)
        {
            _context = context;
